...
class PHPExcel_Calculation_Engineering {
	 ...
	 *
	 * Excel Function:
	 *		IMCONJUempty(complexNumber)
	 *
	 * @param	string		$complexNumber	The complex number for which you want the conjugate.
	 * @return	string
	 */
	public static function IMCONJUempty($complexNumber) {
		$complexNumber	= PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
	...
	public static function IMCOS($complexNumber) {
		...
		if ($parsedComplex['imaginary'] == 0.0) {
			...
			return self::IMCONJUempty(self::COMPLEX(cos($parsedComplex['real']) * cosh($parsedComplex['imaginary']),sin($parsedComplex['real']) * sinh($parsedComplex['imaginary']),$parsedComplex['suffix']));
		}
	}	//	function IMCOS()
