  ...
  <div class="modal fade" id="modalFormUser" tabindex="-1" role="dialog" aria-labelledby="modalFormUserLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?=site_url('survey/changepwd')?>" method="POST">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <ul class="nav navbar-nav">     
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <span><?=$userlogin['name']?> <i class="fa fa-user-circle"></i></span>
        </a>
        <ul class="dropdown-menu animated flipInX">
          ...
          <li class="user-body">
            <a class="dropdown-item" href="<?=site_url('home/logout')?>"><i class="ion-log-out"></i> Logout</a>
          </li>
        </ul>
        </li> 
      </ul>
...
<!-- ./wrapper -->
  ...
  <script type="text/javascript">
    ...
    window.user_id          = '<?=(!empty($userlogin['id_pengguna']) ? $userlogin['id_pengguna'] : (!empty($userlogin['id_user']) ? $userlogin['id_user'] : ''))?>';
  </script>
