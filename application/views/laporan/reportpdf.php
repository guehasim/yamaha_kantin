    ...
    <div class="page">
        ...
        <div style="margin: 0px;">
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                ...
                <tbody>
                        <td>
                            <table class="table table-striped table-border" cellpadding="2" cellspacing="0" style="">
                                <thead>
                                    <th>Tanggal</th>
                                    <th>Makanan</th>
                                </thead>
                                <tbody>
                                    <?php foreach ($laporan_makan as $mkn): ?>
                                    <tr>
                                        <td><?php echo $mkn->tanggal;?></td>
                        ...
                        <td>
                            <table class="table table-striped table-border" cellpadding="2" cellspacing="0" style="">
                                ...
                                <tbody>
                                    <?php foreach ($laporan_minum as $mnm): ?>
                                    <tr>
                                        <td><?php echo $mnm->tanggal;?></td>
                                        <td><?php echo $mnm->nama;?></td>
                                    </tr>
                                    <?php endforeach ?>                                    
                                </tbody>
                            </table>
